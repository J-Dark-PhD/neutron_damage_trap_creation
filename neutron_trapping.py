...
def festim_sim_damage_transient(
    dpa=9,
    T=761,
    results_folder_name="Results/damaged_traps_testing/transients/{:.0}_dpa/",
):

    my_model = F.Simulation(log_level=20)

    # define mesh
    my_model.mesh = F.MeshFromRefinements(5000, size=2e-03)
...
if __name__ == "__main__":
    ...
    # festim_sim_damage(
    #     dpa=9, T=761, results_folder_name="Results/damaged_traps_testing/test/"
    # )

    festim_sim_damage_transient()
    ...
    # festim_sim_no_damage(
    #     results_folder_name="Results/damaged_traps_testing/761.0K/0.0_dpa/"
    # )

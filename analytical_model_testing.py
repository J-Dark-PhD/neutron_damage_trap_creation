...
def plot_trap_density_variation_with_temperature_standard_damage():
    plt.figure()
    plt.plot(T_range, trap_1_densities_by_T, label="Trap 1 (0.87 eV)")
    plt.plot(T_range, trap_2_densities_by_T, label="Trap 2 (1.00 eV)")
    plt.plot(T_range, trap_3_densities_by_T, label="Trap 3 (1.15 eV)")
    plt.plot(T_range, trap_4_densities_by_T, label="Trap 4 (1.35 eV)")
    plt.plot(T_range, trap_5_densities_by_T, label="Trap 5 (1.65 eV)")
    plt.plot(T_range, trap_6_densities_by_T, label="Trap 6 (1.85 eV)")
...
def plot_trap_density_variation_with_damage_standard_temperature():
    plt.figure()
    plt.plot(alt_dpa_range, trap_1_densities_standard_temp, label="Trap 1 (0.87 eV)")
    plt.plot(alt_dpa_range, trap_2_densities_standard_temp, label="Trap 2 (1.00 eV)")
    plt.plot(alt_dpa_range, trap_3_densities_standard_temp, label="Trap 3 (1.15 eV)")

...
plt.plot(temperature_values, inventories_by_dpa[2], label="5 dpa/fpy")
plt.plot(temperature_values, inventories_by_dpa[3], label="9 dpa/fpy")
plt.plot(temperature_values, inventories_by_dpa[4], label="20 dpa/fpy")
plt.legend()
plt.ylabel(r"Hydrogen inventory (m$^{-2}$)")
plt.xlabel(r"Temperature (K)")
plt.xlim(400, 1300)
